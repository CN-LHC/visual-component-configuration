 ...
 * @Last Modified time: 2023-02-22 14:33:29
    ...
    <el-collapse v-model="activeNames">
        ...
        <el-collapse-item title="基础属性配置" name="basics">
            <div class="config_box">
                ...
                <div class="scaleName">
                    <h3>折线类型</h3>
                    <el-radio-group v-model="defaultConfig.lineShape">
                        <el-radio-button v-for="(item, index) in shapeArr" :label="item.value" :key="index">{{ item.label }}</el-radio-button>
                    </el-radio-group>
                </div>
            </div>
        </el-collapse-item>
                ...
                <el-collapse-item title="axis配置" name="x_axis">
                    ...
                    <el-collapse-item title="标题配置" name="x_axis_title">
                        ...
                        <div class="scaleName">
                            ...
                            <div class="scaleName">
                            <h3>标题偏移</h3>
                            <el-input-number v-model="defaultConfig.x.axis.title.offset" size="small" :min="0"></el-input-number>
                        </div>
                        <div class="scaleName">
                            <h3>标题自动旋转</h3>
                ...
                <div class="config_box_item">
                    <el-collapse-item :title="`轴${index + 1}配置`" :name="`y${index + 1}`">
                        <div class="config_box">
                            ...
                            <el-collapse-item title="scale配置" :name="`y${index+1}_scale`">
                                <div class="config_box">
                                    <div class="scaleName">
                                        <h3>渲染范围</h3>
                                        <el-slider
                            ...
                            <el-collapse-item title="axis配置" :name="`y${index + 1}_axis`">
                                <div class="scaleName">
                                    <h3>是否显示</h3>
                                ...
                                <el-collapse-item title="网格配置" :name="`y${index + 1}_axis_grid`">
                                    <!-- <div class="scaleName">
                                        <h3>网格类型</h3>
                                        <el-radio-group v-model="item.axis.grid.line.type">
                                            <el-radio-button label="line">line</el-radio-button>
                                            <el-radio-button label="circle">circle</el-radio-button>
                                        </el-radio-group>
                                    </div> -->
                            ...
                            <el-collapse-item title="数据标签配置" :name="`y${index + 1}_label`">
                                <div class="scaleName">
                                    <h3>数据标签显示</h3>
                                    <el-switch v-model="item.label.isShow" ></el-switch>
                                </div>
                                <div class="scaleName">
                                    <h3>数据标签大小</h3>
                                    <el-input-number v-model="item.label.style.fontSize" size="small" :min="12"></el-input-number>
                                </div>
                                <div class="scaleName">
                                    <h3>数据标签颜色</h3>
                                    <el-color-picker
                                        size="small"
                                        show-alpha
                                        v-model="item.label.style.fill"
                                    ></el-color-picker>
                                </div>
                                <div class="scaleName">
                                    <h3>数据标签文本基线</h3>
                                    <el-radio-group v-model="item.label.style.textBaseline">
                            ...
                            <el-collapse-item title="圆点配置" :name="`y${index + 1}_point`">
                                <div class="scaleName">
                                    <h3>圆点显示</h3>
                                    <el-switch v-model="item.point.isShow" ></el-switch>
                                </div>
                                <div class="scaleName">
                                    <h3>圆点大小</h3>
                                    <el-input-number v-model="item.point.size" size="small" :min="0"></el-input-number>
                                </div>
                                <div class="scaleName">
                                    <h3>圆点边宽</h3>
                                    <el-input-number v-model="item.point.lineWidth" size="small" :min="0"></el-input-number>
                                </div>
                            </el-collapse-item>
                        </div> 
                    </el-collapse-item>
