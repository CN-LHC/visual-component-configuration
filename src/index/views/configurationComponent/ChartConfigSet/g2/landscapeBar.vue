/*
 * @Author: liuhanchuan 
 * @Date: 2023-02-02 14:45:24 
 * @Last Modified by: liuhanchuan
 * @Last Modified time: 2023-02-22 14:12:40
 * 条形图：可配置单条形图、多条形图、堆叠条形图
 */
    ...
    <el-collapse v-model="activeNames">
        ...
        <el-collapse-item title="x轴配置" name="x">
            <div class="config_box">
                <div class="scaleName">
                    <h3>数据绑定</h3>
                    <div class="config_box">
                        <div class="chart_margin" v-for="(item, index) in defaultConfig.xBindData" :key="index">
                            <div class="config_box_item">
                                ...
                                <span class="del_btn" @click="delXValue(index)" v-show="defaultConfig.xBindData.length > 1">
                        ...
                        <el-button icon="el-icon-plus" size="small" @click="addXValue"></el-button>
                    </div>
                </div>
                <el-collapse-item title="scale配置" name="x_scale">
                    <div class="config_box">
                        ...
                        <div class="scaleName">
                            <h3>最小值</h3>
                            <el-input-number v-model="defaultConfig.xScale.min" size="small" label="描述文字"></el-input-number>
                        </div>
                        <div class="scaleName">
                            <h3>最大值</h3>
                            <el-input-number v-model="defaultConfig.xScale.max" size="small" label="描述文字"></el-input-number>
                        </div>
                    </div>
                </el-collapse-item>
        ...
        <el-collapse-item title="y轴配置" name="y">
            <div class="config_box">
                <div class="scaleName">
                    <h3>数据绑定</h3>
                    <el-select v-model="defaultConfig.yBindData" placeholder="请选择">
                        <el-option
                            v-for="key in selectKey"
                            :key="key"
                            :label="key"
...
import { mixin } from "../mixin"
  export default {
    ...
    methods: {
        ...
        addXValue() {
            this.defaultConfig.xBindData.push({
                value: '',
                barColor: ''
            })
        },
        delXValue(index) {
            this.defaultConfig.xBindData.splice(index, 1)
        },
    }
  }
</script>
