/*
 * @Author: liuhanchuan 
 * @Date: 2023-02-02 14:43:38 
 * @Last Modified by: liuhanchuan
 * @Last Modified time: 2023-02-22 14:13:04
 * 区域图：可配置单区域、多区域、双y轴区域图
 */
                ...
                <div class="config_box_item">
                    <el-collapse-item :title="`轴${index + 1}配置`" :name="`y${index + 1}`">
                        <div class="config_box">
                            ...
                            <el-collapse-item title="线配置" :name="`y${index + 1}_line`">
                                <div class="scaleName">
                                    <h3>线显示</h3>
                                    <el-switch v-model="item.line.isShow" ></el-switch>
                                </div>
                                <div class="scaleName">
                                    <h3>线粗细</h3>
                                    <el-input-number v-model="item.line.lineWidth" size="small" :min="0"></el-input-number>
                                </div>
                            </el-collapse-item>
                        </div> 
                    </el-collapse-item>
