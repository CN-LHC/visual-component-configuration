 ...
 * @Last Modified time: 2023-01-16 15:43:57
 * k线图配置
 */
<template>
    <el-collapse v-model="activeNames">
        <el-collapse-item title="数据绑定" name="basic_data">
            <div class="scaleName">
                <h3>name</h3>
                <el-select v-model="defaultConfig.data.name" placeholder="请选择">
                    <el-option
            ...
            <div class="scaleName">
                <h3>开盘价</h3>
                <el-select v-model="defaultConfig.data.openPrice" placeholder="请选择">
                    <el-option
                        v-for="key in selectKey"
                        :key="key"
                        :label="key"
            ...
            <div class="scaleName">
                <h3>收盘价</h3>
                <el-select v-model="defaultConfig.data.closePrice" placeholder="请选择">
                    <el-option
                        v-for="key in selectKey"
                        :key="key"
                        :label="key"
            ...
            <div class="scaleName">
                <h3>最高价</h3>
                <el-select v-model="defaultConfig.data.highPrice" placeholder="请选择">
                    <el-option
                        v-for="key in selectKey"
                        :key="key"
                        :label="key"
            ...
            <div class="scaleName">
                <h3>最低价</h3>
                <el-select v-model="defaultConfig.data.lowPrice" placeholder="请选择">
                    <el-option
                        v-for="key in selectKey"
                        :key="key"
                        :label="key"
            ...
            <div class="config_box">
                ...
                <div class="scaleName">
                    ...
                    <el-color-picker
                        size="small"
                        show-alpha
                        v-model="defaultConfig.bollColor"
                    ></el-color-picker>
                </div>
                <div class="scaleName">
                    <h3>背景色</h3>
