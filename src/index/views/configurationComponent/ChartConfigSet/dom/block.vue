 ...
 * @Last Modified time: 2023-02-22 14:37:36
 * 方块树图
 */
<template>
    <el-collapse v-model="activeNames">
        ...
        <el-collapse-item title="基础属性配置" name="basics">
            <div class="config_box">
                ...
                <div class="scaleName">
                    <h3>间距</h3>
                    <el-input-number v-model="defaultConfig.padding" size="small" :min="0"></el-input-number>
                </div>
                <div class="scaleName">
                    <h3>圆角</h3>
                    <el-input-number v-model="defaultConfig.radius" size="small" :min="0"></el-input-number>
                </div>
                <div class="scaleName">
                    <h3>数量</h3>
                ...
                <div class="scaleName">
                    <h3>字体大小</h3>
                    <el-input-number v-model="defaultConfig.fontSize" size="small" :min="12" label="描述文字"></el-input-number>
                </div>
                <div class="scaleName">
                    <h3>字体颜色</h3>
                    <el-color-picker
                        size="small"
                        show-alpha
                        v-model="defaultConfig.fontColor"
                    ></el-color-picker>
                </div>
                <div class="scaleName">
                    <h3>方块颜色</h3>
                    <el-color-picker
                        size="small"
                        show-alpha
                        v-model="defaultConfig.bgColor"
                    ></el-color-picker>
                </div>
                <div class="scaleName">
                    <h3>方块长度</h3>
                    <el-input-number v-model="defaultConfig.widthScale" size="small" :min="0" :max="100"></el-input-number>
                </div>
                <div class="scaleName">
                    <h3>值后缀</h3>
